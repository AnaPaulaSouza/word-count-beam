 ...
 * {@link WritePubSub}. After you've looked at this example, then see the {@link WindowedWordCount}
...
public class DebuggingWordCount {
   ...
   * WritePubSub.WordCountOptions}.
   */
  public interface WordCountOptions extends WritePubSub.WordCountOptions {
  ...
  static void runDebuggingWordCount(WordCountOptions options) {
    ...
    PCollection<KV<String, Long>> filteredWords =
        p.apply("ReadLines", TextIO.read().from(options.getInputFile()))
            .apply(new WritePubSub.CountWords())
