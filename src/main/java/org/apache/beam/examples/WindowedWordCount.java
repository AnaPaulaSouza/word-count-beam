...
import com.b2wdigital.WritePubSub;
 ...
 * detailed 'word count' examples. First take a look at {@link MinimalWordCount}, {@link WritePubSub},
...
public class WindowedWordCount {
   ...
   * well as the {@link WritePubSub.WordCountOptions} support for specification of the input and
   * output files.
   */
  public interface Options
      extends WritePubSub.WordCountOptions, ExampleOptions, ExampleBigQueryTableOptions {
  ...
  static void runWindowedWordCount(Options options) throws IOException {
     ...
     */
    PCollection<KV<String, Long>> wordCounts = windowedWords.apply(new WritePubSub.CountWords());
     ...
     */
    wordCounts
        .apply(MapElements.via(new WritePubSub.FormatAsTextFn()))
